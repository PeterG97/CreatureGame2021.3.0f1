...
public class UIManager : PermanentMonoSingleton<UIManager>
{
    ...
    //Performance
    [NonSerialized] public TMP_Text hideOptionsText, fpsText, plantPopulationText, animalPopulationText,
    ...
    public void DisplayAnimalInfo(Animal _animal, Vector2 _position)
    {
        ...
        //Abilities
        hpRegenText.text = _animal.hitPointsRegenSpeed.ToString("F0");
