...
public class LifeformManager : PermanentMonoSingleton<LifeformManager>
{
    #region ---=== Auto Assigned/Constant Variables ===---
    /* Dependent on Classes:
     * PermanentMonoSingleton - GameManager
     * PermanentMonoSingleton - UIManager */
    #endregion
    ...
    public void RandomizeAnimal(Animal _animal)
    {
        ...
        //Reproduction
        _animal.reproductionTimerMax = UnityEngine.Random.Range(reproductionAgePercentMin * _animal.maxAge, reproductionAgePercentMax * _animal.maxAge);
    ...
    public Animal AnimalSexualReproduction(Animal _animal1, Animal _animal2)
    {
        ...
        //Reproduction
        float parentsReproductionTimerMax = (_animal1.reproductionTimerMax + _animal2.reproductionTimerMax) / 2;
        _baby.reproductionTimerMax = UnityEngine.Random.Range(parentsReproductionTimerMax * variationMult, parentsReproductionTimerMax / variationMult);
        ...
        //Update Parents
        _animal1.ResetAfterBreed(sexualNutritionLost, sexualDeathAgeLost);
        _animal2.ResetAfterBreed(sexualNutritionLost, sexualDeathAgeLost);
    ...
    public Animal AnimalAsexualReproduction(Animal _animal)
    {
        ...
        //Reproduction
        _baby.reproductionTimerMax = UnityEngine.Random.Range(_animal.reproductionTimerMax * variationMult, _animal.reproductionTimerMax / variationMult);
        ...
        //Update Parent
        _animal.ResetAfterBreed(sexualNutritionLost, asexualDeathAgeLost);
